...
export const metadata: Metadata = {
  title: {
    default: '無料ブラウザゲームサイト @games.wellwich.com ',
    template: `%s | 無料ブラウザゲームサイト @games.wellwich.com`
  },
        ...
        <header>
          <nav className="flex items-center justify-between flex-wrap bg-gray-500 p-6">
            <div className="flex items-center flex-shrink-0 text-white mr-6">
              <h1 className="font-semibold text-xl tracking-tight">無料ブラウザゲームサイト @games.wellwich.com</h1>
            </div>
